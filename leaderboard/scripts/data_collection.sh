...
export ROUTES=${WORK_DIR}/leaderboard/data/TCP_training_routes/routes_town01_val.xml
export TEAM_AGENT=${WORK_DIR}/team_code/roach_ap_agent.py
export TEAM_CONFIG=${WORK_DIR}/roach/config/config_agent.yaml
export CHECKPOINT_ENDPOINT=${WORK_DIR}/results/data_collect_town01_results.json
export SCENARIOS=${WORK_DIR}/leaderboard/data/scenarios/town01_all_scenarios.json
export SAVE_PATH=${WORK_DIR}/data/data_collect_town01_results/
